...
export default function ForDPOPage() {
  return (
    <>
      ...
      <JsonLd data={servicePageSchema({ name: "SealMetrics for DPOs", description: "No cookies, no PII, no consent dependency, EU-only infrastructure. SealMetrics is the analytics platform your privacy team will sign off on.", url: "/for/dpo", audience: "Data Protection Officers" })} />
      {/* Hero */}
