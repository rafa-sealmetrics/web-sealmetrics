...
export default function ForHealthcarePage() {
  return (
    <>
      ...
      <JsonLd data={servicePageSchema({ name: "SealMetrics for Healthcare", description: "Healthcare faces the highest privacy bar in Europe. SealMetrics captures 100% of visitor journeys without cookies or personal data — GDPR compliant.", url: "/for/healthcare", audience: "Healthcare Organizations" })} />
      {/* Hero */}
