...
export const metadata: Metadata = {
  ...
  description:
    "Financial services face the strictest consent requirements in Europe. SealMetrics captures 100% of visitor journeys without cookies, fully GDPR compliant.",
  openGraph: {
...
export default function ForFinancePage() {
  return (
    <>
      ...
      <JsonLd data={servicePageSchema({ name: "SealMetrics for Finance", description: "Financial services face the strictest consent requirements in Europe. SealMetrics captures 100% of visitor journeys without cookies — fully GDPR compliant, EU-hosted.", url: "/for/finance", audience: "Financial Services" })} />
      {/* Hero */}
