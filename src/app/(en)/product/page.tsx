          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-[1rem] leading-[1.7] text-text-secondary mb-6">
                ...
                browser settings, or ad blocker usage. For{" "}
                <Link
                  href="/for/dpo"
                  className="text-text-primary no-underline border-b border-warm-200 hover:border-text-body transition-colors"
                >
                ...
                , this means analytics without GDPR risk.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-[1rem] leading-[1.7] text-text-secondary mb-6">
                ...
                typically see 3&ndash;8x more attributed revenue than GA4 reports.
              </p>
              <ul className="space-y-2">
                {[
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-[1rem] leading-[1.7] text-text-secondary mb-6">
                ...
                dashboards that need interpretation. Ideal for{" "}
                <Link
                  href="/for/cto"
                  className="text-text-primary no-underline border-b border-warm-200 hover:border-text-body transition-colors"
                >
