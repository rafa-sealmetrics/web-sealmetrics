...
export const metadata: Metadata = {
  title: "Consentless Analytics for Europe — About SealMetrics",
  description: "SealMetrics: consentless analytics trusted by 2,000+ EU teams. No cookies, no personal data, 100% EU-hosted. See 40–60% more traffic than GA4. Founded 2020.",
  openGraph: {
    title: "Consentless Analytics for Europe — About SealMetrics",
    description: "SealMetrics: consentless analytics trusted by 2,000+ EU teams. No cookies, no personal data, 100% EU-hosted. See 40–60% more traffic than GA4. Founded 2020.",
    type: "website",
      ...
      <section className="py-28 bg-warm-50 border-t border-warm-100">
        <div className="max-w-[900px] mx-auto px-5 sm:px-10">
          ...
          <div className="mt-10 space-y-6 text-[17px] leading-[1.7] text-ink-2">
            <p>
              Rafa Jiménez spent two decades in European eCommerce. He worked as a digital marketer, then as an agency founder, then as an advisor to retail groups with 10M€+ in annual online revenue. Every meeting followed the same pattern: the GA4 number, the pixel number, the CRM number. All different. All defended. None trusted.
            </p>
            <p>
              In some organisations, reconciling those three figures took more analyst hours each month than acting on any of them.
            </p>
            <p>
              The problem was never the analysts. It was the architecture. Every tool optimised for its own reporting. GDPR consent rules made 40–60% of EU traffic invisible to standard analytics. Sub-processor chains stretched across three continents. DPOs could not sign off on the legal exposure. Teams were measuring the tools, not the business.
            </p>
            <p>
