...
export const metadata: Metadata = {
  ...
  description:
    "SealMetrics is consentless analytics built for eCommerce. Capture 100% of traffic without cookies or consent banners. GDPR-compliant, EU-hosted. No GA4 blind spots.",
  openGraph: {
    title: "Consentless Analytics for eCommerce — 100% Traffic, No Cookies",
    description:
