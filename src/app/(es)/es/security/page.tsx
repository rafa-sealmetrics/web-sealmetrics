...
const faqs = [
  ...
  { q: "¿Cómo cumple SealMetrics el RGPD por arquitectura?", a: "SealMetrics está diseñado para evitar la recolección de datos personales: sin cookies, sin identificadores, sin fingerprinting y sin perfilado por usuario. Los eventos se cuentan de forma anónima, se procesan en Dublín, y vienen acompañados de DPA y documentación TPSR." },
  ...
  return (
    <>
      ...
      <TldrBlock
        label="En resumen"
        answer={
          <>SealMetrics cumple <strong>RGPD por arquitectura</strong> — no por una capa de compliance añadida después. Sin cookies, sin identificadores personales, sin fingerprinting. Todo el procesamiento ocurre en Dublín (Irlanda), sobre infraestructura propiedad UE y cero sub-procesadores fuera de UE, con DPA y documentación TPSR disponibles para procurement review.</>
        }
        bullets={[
      ...
      <section className="py-28 bg-warm-50 border-t border-warm-100">
        <div className="max-w-[1280px] mx-auto px-5 sm:px-10">
          <div className="grid md:grid-cols-[1.1fr_1fr] gap-12 md:gap-16 items-end mb-12">
            <div>
              <span className="eyebrow mb-5">Postura compliance</span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {[
              { name: "RGPD", desc: "Cumplido por arquitectura — sin recolección de dato personal." },
