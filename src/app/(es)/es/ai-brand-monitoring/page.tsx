...
const description =
  "Informe gratuito: quince modelos de IA contestan seis preguntas sobre tu empresa de memoria, sin búsqueda web. Lee lo que dijo cada uno, cita a cita.";
    ...
    <>
      ...
      <JsonLd
        data={servicePageSchema({
          ...
          description:
            "Informe gratuito que hace seis preguntas fijas sobre una empresa a quince modelos de IA, sin búsqueda web, y devuelve cada respuesta literal con los errores de hecho marcados.",
