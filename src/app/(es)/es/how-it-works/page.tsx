...
const howItWorksFaqs = [
  {
    q: "¿Cómo funciona el tracking cookieless sin identificar usuarios?",
    a: "SealMetrics utiliza recopilación cookieless first-party para capturar datos de comportamiento (páginas visitadas, referrer, tipo de navegador, duración de sesión) sin almacenar nada en el dispositivo del visitante. Sin cookies, sin localStorage, sin fingerprinting. Las sesiones se reconstruyen sin identificadores personales.",
  },
  {
  ...
  },
  {
    ...
    a: "5 minutos. Añade un tag JavaScript a tu web, ya sea directamente en el HTML o a través de Google Tag Manager. Sin configuración de consent mode, sin integración con banners de cookies y sin variables de Tag Manager que configurar.",
  },
  {
  ...
  },
  {
    ...
    a: "Nunca bloqueamos tu tracking. Al 80% de tu límite de eventos recibes un email de alerta, al 100% una notificación en el dashboard y al 120% nos ponemos en contacto para hablar de un upgrade. No se pierde ningún dato durante ningún período de exceso.",
  },
];
        ...
        <div className="max-w-[1200px] mx-auto px-5 sm:px-8">
          <div className="max-w-[700px]">
            ...
            <p className="text-[1.2rem] leading-[1.75] text-text-secondary">
              La analítica tradicional pierde la mayor parte de tus datos antes
              de que lleguen a registrarse. SealMetrics se construyó desde cero
        ...
        <div className="max-w-[1200px] mx-auto px-5 sm:px-8">
          <div className="max-w-[800px]">
            ...
            <p className="text-[1.05rem] leading-[1.75] text-text-secondary mb-10">
              ...
              de navegador, solo una fracción de ellos queda registrada por las
            ...
            <div className="space-y-8">
              {[
                ...
                {
                  step: "16,400",
                  label: "Tras los límites de cookies de Safari ITP y Firefox ETP",
                  width: "23%",
                  color: "bg-text-tertiary",
                },
                {
                  step: "10,000",
                  label: "Lo que GA4 reporta como tu tráfico total",
                  width: "14%",
                  color: "bg-red-alert",
                },
              ].map((item) => (
            ...
            <div className="mt-10 p-6 bg-warm-white border border-warm-100 rounded-[4px]">
              ...
              <p className="text-[0.8rem] text-text-tertiary mt-3">
                Captura del 100%. Sin dependencia de consentimiento. Sin pérdida de datos.
              </p>
            </div>
        ...
        <div className="max-w-[1200px] mx-auto px-5 sm:px-8">
          ...
          <div className="space-y-20">
            {[
              {
                number: "01",
                title: "Recopilación de datos first-party",
                desc: "Un script ligero de 846 bytes se ejecuta en tu dominio. Recopila datos de comportamiento mediante métodos first-party, lo que significa que los datos viajan directamente desde el navegador de tu visitante a tu dominio, sin pasar nunca por un tercero.",
                details: [
              ...
              },
              {
                ...
                details: [
                  ...
                  "Granularidad a nivel de sesión para cada visitante",
              ...
              },
              {
                ...
                desc: "Los datos completos permiten inteligencia completa. Nueve informes especializados, atribución de ingresos, detección de anomalías LENS AI con 60+ reglas, todo construido sobre la imagen completa, no sobre aproximaciones. Tracking de agentes IA disponible próximamente.",
                details: [
                  "9 tipos de informes que cubren todo el funnel",
                  "Atribución de ingresos por canal, campaña y creatividad",
                  "LENS AI: haz preguntas en lenguaje natural, obtiene respuestas de datos reales",
                  "Tracking de agentes IA: ve las visitas de GPT, Claude y Perplexity como sesiones (Próximamente)",
                  "Atribución de ingresos por canal, campaña y creatividad",
                ],
              },
            ].map((step) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
            {[
              ...
              },
              {
                ...
                desc: "Las peticiones de analítica de terceros son lo primero que bloquean las herramientas de privacidad. SealMetrics opera como infraestructura first-party en tu dominio: la ruta de datos es entre tu visitante y tu dominio, sin ninguna llamada externa que interceptar.",
              },
              {
