...
export default function Page() {
  return (
    <>
      ...
      <JsonLd data={comparisonPageSchema({ name: "SealMetrics vs Piwik PRO", description: "Comparativa lado a lado: SealMetrics vs Piwik PRO en arquitectura, hosting UE y dependencia de consentimiento.", url: "/es/vs/piwik-pro", competitor: { name: "Piwik PRO", url: "https://piwik.pro/" } })} /><VsComparisonV3 data={getVsData("piwik-pro", "es")} />
      <RelatedPagesV3
        locale="es"
