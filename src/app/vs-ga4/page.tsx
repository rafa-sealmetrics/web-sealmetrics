...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "SealMetrics vs Google Analytics 4 — Detailed Comparison",
    description:
      "A data-driven comparison between SealMetrics and GA4. 13% vs 100% data capture, enterprise analytics from €599/mo.",
    type: "website",
  },
  alternates: {
...
const vsGa4Faqs = [
  ...
  {
    q: "Why is GA4 free while SealMetrics costs €599/month?",
    a: "GA4 is free because Google monetizes the data through its advertising ecosystem. SealMetrics is an independent, EU-based analytics platform with no advertising business model. The €599/mo Growth plan includes core analytics, API, LENS AI, BigQuery, 5M events/month, and EU-only data residency. Annual billing starts at €499/mo.",
  },
  {
...
const comparisonRows = [
  ...
  { feature: "Starting price", sm: "From €599/mo", ga: "Free (GA360: ~$150,000/yr)", category: "Other" },
