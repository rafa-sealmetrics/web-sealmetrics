    ...
    <>
      ...
      <article className="pt-12 pb-28 bg-white">
        ...
        <div className="space-y-6 text-[1.05rem] leading-[1.8] text-text-body">
          ...
          <p>First-party data collection routes the data through your own domain. The request goes from the visitor&rsquo;s browser to your-domain.com, processed by <Link href="/glossary/server-side-tracking" className="text-text-primary no-underline border-b border-warm-200 pb-0.5 hover:border-text-primary transition-colors">server-side tracking</Link> infrastructure running on your domain. To the browser and to ad blockers, this is indistinguishable from any other first-party request.</p>
