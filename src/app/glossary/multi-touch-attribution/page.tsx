...
export default function MultiTouchAttributionPage() {
  return (
    <>
      ...
      <JsonLd data={definedTermSchema({ name: "Multi-Touch Attribution", description: "An attribution model that distributes conversion credit across multiple touchpoints.", url: "/glossary/multi-touch-attribution" })} />
