...
export const metadata: Metadata = {
  ...
  description:
    "Your signup-to-paid journey spans weeks and multiple sessions. Cookie-based analytics loses the thread. SealMetrics captures every touchpoint — cookieless, 100% complete.",
  openGraph: {
