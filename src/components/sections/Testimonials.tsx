const testimonials = [
  {
    ...
    companyDetail: null as string | null,
            ...
            >
              ...
              <div className="flex items-center gap-3">
                {t.photo ? (
                  ...
                  <div className="w-10 h-10 rounded-full bg-warm-100 flex items-center justify-center text-[0.85rem] font-medium text-text-tertiary shrink-0">
                    {(t.name || t.title).charAt(0).toUpperCase()}
                  </div>
                )}
                <div>
                  {t.name ? (
