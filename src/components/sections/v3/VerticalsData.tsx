  ...
  const data: Record<VerticalKey, Record<Locale, Omit<VerticalPageData, "locale">>> = {
    ...
    hotels: {
      en: {
        ...
        outcomes: [
          { n: "+30%", label: "Traffic recovered", detail: "Consent-rejection gap closed. Mobile Safari visitors counted." },
          { n: "25%", label: "CRM bookings now visible", detail: "Real reservations attributed to the channel that drove them." },
          { n: "Portfolio", label: "Multi-property rollup", detail: "Brand, sub-brand, individual properties — one dashboard." },
          { n: "0", label: "Consent banner tax", detail: "Cleaner UX on mobile. +8% lower bounce rate typical." },
        ],
        quote: { text: "It's no longer a tool that sits next to the process. It's the tool that gives us the real data — and the one we make decisions with.", cite: "Head of eCommerce · Hotel chain, Spain" },
        faqs: [
      ...
      es: {
        ...
        outcomes: [
          { n: "+30%", label: "Tráfico recuperado", detail: "Cerrado el gap de consentimiento. Visitantes de Safari móvil contados." },
          { n: "25%", label: "Reservas CRM visibles", detail: "Reservas reales atribuidas al canal que las generó." },
          { n: "Portfolio", label: "Rollup multi-propiedad", detail: "Marca, sub-marca, propiedades individuales — un dashboard." },
          { n: "0", label: "Penalización banner", detail: "UX más limpia en móvil. +8% menos rebote típico." },
        ],
        quote: { text: "Ya no es una herramienta que está al lado del proceso. Es la que nos da el dato real — y con la que tomamos decisiones.", cite: "Head of eCommerce · Cadena hotelera, España" },
        faqs: [
    ...
    agencies: {
      en: {
        ...
        faqs: [
          ...
          { q: "What about Looker Studio / Power BI dashboards?", a: "Native BigQuery export means any BI tool (Looker Studio, Power BI, Tableau, Metabase) connects directly. No ETL, no sampled exports, no quota issues." },
          faqMigration.en,
          faqGDPR.en,
        ],
      ...
      es: {
        ...
        faqs: [
          ...
          { q: "¿Y dashboards en Looker Studio / Power BI?", a: "Export nativo BigQuery = cualquier herramienta BI (Looker Studio, Power BI, Tableau, Metabase) conecta directo. Sin ETL, sin exports muestreados, sin problemas de cuota." },
          faqMigration.es,
          faqGDPR.es,
        ],
